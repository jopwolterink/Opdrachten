...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="release_date" HeaderText="release_date" ReadOnly="True" SortExpression="release_date" />
    </Columns>
</asp:GridView>
<asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="review_id" DataSourceID="SqlDataSource2" Height="50px" Width="526px">
    <Fields>
        <asp:BoundField DataField="summary" HeaderText="summary" SortExpression="summary" />
        <asp:BoundField DataField="rating" HeaderText="rating" SortExpression="rating" />
        <asp:BoundField DataField="review" HeaderText="review" InsertVisible="False" ReadOnly="True" SortExpression="review" />
